...
- [x] `docker compose up --build` starts the complete application.
- [x] Restarting without deleting the volume preserves balances and records.
- [x] Setup instructions and documentation match the implementation.
